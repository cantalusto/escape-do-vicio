...
export default function Challenge3() {
  ...
  const correctAnswer = 1; // "Pulmão"
  const options = tArray('question3Options');
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      <div className="mb-6">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-800">{t('enigma3')}</h2>
        </div>
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
          <p className="text-lg text-gray-700 font-medium text-center italic">
            &ldquo;{t('question3')}&rdquo;
          </p>
        </div>
      </div>
